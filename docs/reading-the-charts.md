...
The label "Public & Other Services" abbreviates the source's public administration, education, health, and other services sector. The pooled rankings appear first in the README gallery, followed by notebook heatmap queries for USA, China, and the UK in 2000. The country/year averages bar chart remains available locally but is not displayed in the README. All three heatmaps share a linear 0-50 billion USD scale and sector ordering; values above 50 billion saturate. Green, red, and navy blue palettes identify USA, China, and the UK respectively.
